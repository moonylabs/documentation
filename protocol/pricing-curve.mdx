---
title: 'Pricing Curve'
description: 'The deterministic pricing curve that governs MNY pricing'
icon: chart-line
---
...
<div className="principle-card formula-card" style={{
  ...
  <div className="card-divider" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '0.5px solid #e5e7eb', fontSize: '0.75rem', color: '#6b7280' }}>
    Source: <a href="https://github.com/code-payments/flipcash-program/blob/main/api/src/curve.rs#L22-L28" className="brand-link">Flipcash Program</a>
  </div>
</div>
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div className="card-divider" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '0.5px solid #e5e7eb', fontSize: '0.75rem', color: '#6b7280' }}>
      Source: <a href="https://github.com/code-payments/flipcash-program/blob/main/api/src/consts.rs#L18-L20" className="brand-link">Flipcash Program</a>
    </div>
  </div>
...
<div className="principle-card formula-card" style={{
  ...
  <div className="card-divider" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '0.5px solid #e5e7eb', fontSize: '0.75rem', color: '#6b7280' }}>
    Source: <a href="https://github.com/code-payments/flipcash-program/blob/main/api/src/curve.rs#L36-L54" className="brand-link">Flipcash Program</a>
  </div>
</div>
...
<div className="principle-card formula-card" style={{
  ...
  <div className="card-divider" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '0.5px solid #e5e7eb', fontSize: '0.75rem', color: '#6b7280' }}>
    Source: <a href="https://github.com/code-payments/flipcash-program/blob/main/api/src/curve.rs#L62-L74" className="brand-link">Flipcash Program</a>
  </div>
</div>
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div className="card-divider" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '0.5px solid #e5e7eb', fontSize: '0.75rem', color: '#6b7280' }}>
      Source: <a href="https://github.com/code-payments/flipcash-program/blob/main/api/src/table.rs" className="brand-link">Flipcash Program</a>
    </div>
  </div>
...
<div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1.5rem', marginBottom: '2rem' }}>
  ...
  <div className="principle-card" style={{
    ...
    <div className="card-divider" style={{ marginTop: '1rem', paddingTop: '0.75rem', borderTop: '0.5px solid #e5e7eb', fontSize: '0.75rem', color: '#6b7280' }}>
      Source: <a href="https://github.com/code-payments/flipcash-program/blob/main/api/src/table.rs#L6" className="brand-link">Flipcash Program</a>
    </div>
  </div>
