...
<Warning>
These addresses are provided for transparency and verification purposes only. Do not send tokens directly to these addresses. To interact with the Moony Reserve, use the Flipcash app or a compatible interface.
</Warning>
...
<AddressCard
  ...
  address="EEMP4DQcXzw56avKxPhmh2Kjdxxvwavt5ecLUKcxVeTW"
  description="The Reserve state account. This PDA stores the pool configuration and links to all vaults."
  explorerUrl="https://explorer.solana.com/address/EEMP4DQcXzw56avKxPhmh2Kjdxxvwavt5ecLUKcxVeTW"
  isPlaceholder={true}
/>
...
<AddressCard
  id="mny-vault-card"
  label="MNY Vault"
  address="BMYftxDcbLDTzRCkLmQ9amwNgqsZ74A1wsd1gURum3Ep"
  description="Holds the unreleased MNY supply. Do not send tokens directly to this address."
  explorerUrl="https://explorer.solana.com/address/BMYftxDcbLDTzRCkLmQ9amwNgqsZ74A1wsd1gURum3Ep"
  isPlaceholder={true}
/>
...
<AddressCard
  id="usdf-vault-card"
  label="USDF Vault"
  address="3QEYi2emN2ggYGG66RYdgDhNnumXTuQec4Ar6o5qpb6R"
  description="Holds the USDF reserve backing circulating MNY. Do not send tokens directly to this address."
  explorerUrl="https://explorer.solana.com/address/3QEYi2emN2ggYGG66RYdgDhNnumXTuQec4Ar6o5qpb6R"
  isPlaceholder={true}
/>
